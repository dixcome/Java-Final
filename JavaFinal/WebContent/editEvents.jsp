    ...
    <%
        ...
        for (int i=0; i<n; i++) {
            ...
            out.println("<center><div class='panel'><form method='post' action='DeleteNewsServlet'><input type='hidden' name='id' value='"+
                    eventsArrayList.get(eventsArrayList.size() - 1).getA_name()+"'><input type='hidden' name='type' value='events'><button class='btn btn-primary btn-ghost' type='submit'>Delete</button></form>" +
                    ...
                    "<input type='text' name='txt' placeholder='Location...'><button class='btn btn-primary btn-ghost' type='submit'>Change</button></form>"+
                    "</div></center>");
        }
    %>
</div>
